...
use crate::brokerage::AssetTradeFill;
use actix::prelude::*;
use log::debug;
...
impl Handler<AssetTradeFill> for PositionManager {
    type Result = ();

    fn handle(&mut self, msg: AssetTradeFill, _ctx: &mut Context<Self>) -> Self::Result {
        let AssetTradeFill(asset, msg) = msg;
        self.positions
        ...
        self.positions.retain(|_, v| v.qty != 0);
    }
}
